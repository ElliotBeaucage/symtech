    ...
    <main class="min-h-screen bg-gray-100 flex items-center justify-center py-10 px-4">
        <div class="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('machines.update') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="buildings-adresse" class="block text-sm font-medium text-gray-700">Nom de la
                        machine</label>
                    ...
                    <label for="bureau" class="block text-sm font-medium text-gray-700 mt-4">Numéro de bureau</label>
                    <input type="text" id="bureau" name="bureau" value="{{ old('bureau', $machine->bureau) }}"
                        class="w-full px-4 py-2 mt-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    ...
                    <input type="text" id="freon" name="freon" value="{{ $machine->freon }}"
                        class="w-full px-4 py-2 mt-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        placeholder="Freon">
                    <label for="buildings-adresse"
                        class="block text-sm font-medium text-gray-700">Recommandation</label>
                ...
                <div class="flex justify-between items-center mt-6">
                    <a href="{{ route('machines.index', ['buildings' => $machine->building_id]) }}"
                        class="text-gray-600 hover:text-gray-800 font-semibold">Annuler</a>
                    <button type="submit"
                        class="px-6 py-2 text-white bg-[#003E7E] rounded hover:bg-[#003E7E] focus:outline-none focus:ring-2 ">
                        Sauvegarder
                    </button>
                </div>
            </form>
